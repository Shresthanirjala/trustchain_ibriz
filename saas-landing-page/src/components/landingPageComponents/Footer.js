...
function Footer() {
  return (
    <footer className="border-t border-gray-800 bg-gradient-to-b from-black via-gray-900 to-blue-900">
      <MaxWidthWrapper className="py-14 pb-20 flex flex-col items-center justify-center md:items-start md:justify-between md:flex-row">
        ...
        <div className="max-w-[18rem] flex flex-col space-y-4 items-center justify-center md:items-start md:justify-normal">
          ...
          <p className="text-gray-400 md:text-[0.875rem] font-medium text-center md:text-left">
            Verifiable skill identity on blockchain for trustworthy hiring
          </p>
          ...
          <small className="mb-2 block text-gray-500 select-none">
            TrustChain &copy; {new Date().getFullYear()} - All rights reserved
          </small>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-24 mt-10 md:mt-0">
          ...
          <div className="flex flex-col items-center md:items-start px-4">
            <h3 className="font-semibold text-blue-300 mb-4">PRODUCT</h3>
            <ul className="space-y-3 text-gray-400 text-sm text-center md:text-left">
          ...
          {/* Resources Links */}
          <div className="flex flex-col items-center md:items-start px-4">
            <h3 className="font-semibold text-blue-300 mb-4">RESOURCES</h3>
            <ul className="space-y-3 text-gray-400 text-sm text-center md:text-left">
              <li className="hover:text-blue-300 transition-colors">
                <a href="/developers" className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 mr-2 text-blue-500"
                    viewBox="0 0 20 20"
              ...
              <li className="hover:text-blue-300 transition-colors">
                <a href="/recruiters" className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 mr-2 text-blue-500"
                    viewBox="0 0 20 20"
          ...
          {/* Legal Links */}
          <div className="flex flex-col items-center md:items-start px-4">
            <h3 className="font-semibold text-blue-300 mb-4">LEGAL</h3>
            <ul className="space-y-3 text-gray-400 text-sm text-center md:text-left">
              <li className="hover:text-blue-300 transition-colors">
      ...
      {/* Bottom bar with verification lookup */}
      <div className="bg-black py-4">
        <MaxWidthWrapper>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <p className="text-blue-200 text-sm mb-4 md:mb-0">
              Verify a TrustChain ID or submit your GitHub profile
            </p>
            <div className="flex w-full md:w-auto">
              <input
                type="text"
                placeholder="Enter TrustChain ID or GitHub username"
                className="py-2 px-4 rounded-l outline-none text-sm w-full md:w-64 bg-gray-800 text-gray-200 border border-gray-700 focus:ring-2 focus:ring-blue-500"
              />
              <button className="bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-r text-sm font-medium transition-colors">
                Verify
              </button>
            </div>
          </div>
